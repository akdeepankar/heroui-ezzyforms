  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (isDeleting) {
        ...
        setDisplayedWord(
          animatedWords[wordIndex].substring(0, displayedWord.length + 1),
        );
        setTypingSpeed(150);
      }
    ...
    <div className="py-20 md:py-28">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-6 space-y-8">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight tracking-tight">
            ...
            <span className="relative">
              ...
              <span className="absolute -bottom-1 left-0 w-full h-[3px] bg-gradient-to-r from-blue-500 to-purple-600 rounded-full" />
            </span>
          </h1>

          <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
            Create beautiful, responsive forms in minutes with our intuitive
            drag-and-drop builder. Save time, increase conversion rates, and get
            actionable insights.
          </p>
        ...
        <div className="md:col-span-6 relative">
          <div className="absolute -top-10 -left-10 w-40 h-40 bg-gradient-to-br from-yellow-100 to-orange-100 rounded-full blur-3xl opacity-70 animate-pulse" />
          <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full blur-3xl opacity-70" />
          ...
          <div className="relative bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden transform hover:scale-[1.02] transition-all duration-500">
            ...
            <img
              ...
              onError={(e) => {
                e.target.src =
                  "https://placehold.co/600x400/5046e5/white?text=EzzyForms+Interface";
              }}
            />
            ...
            {/* Animated cursor */}
            <div className="absolute bottom-20 left-[40%] w-4 h-4 bg-blue-500 rounded-full z-20 animate-ping opacity-75" />
          </div>
        ...
        <div className="relative">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-16 gap-y-8">
            {[
              ...
              <div
                key={index}
                className="text-gray-400 hover:text-gray-600 transition-colors transform hover:scale-110 transition-transform"
              >
                <Icon
                  className="opacity-80 hover:opacity-100"
                  icon={brand.icon}
                  width={index % 2 === 0 ? 36 : 30}
                />
              </div>
            ))}
          </div>
